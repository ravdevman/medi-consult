...
@section("content")
    ...
    <div class="center-container">
        <div class="container-card search">
            <h5><i class="bi bi-filter" style="margin-right: 5px"></i>Filtrer</h5>
    ...
    <h3><i class="bi bi-circle-fill" style="margin-right: 5px; color: #5ad65a; font-size: 12px"></i>Médecins disponibles</h3>
